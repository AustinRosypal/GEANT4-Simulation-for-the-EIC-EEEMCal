...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
    ...
    // Use 455 mm as a practical 17-ish X0 scale surrogate from ECCE studies
    ...
    const G4double fPWOOuterRadius = 260.0;  // mm  acceptance boundary
